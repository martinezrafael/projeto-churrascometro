...
function calcular() {
  ...
  resultado.innerHTML += `<p>${Math.ceil(qtdTotalCerveja/350)} latinhas de 350ml de cerveja</p>`
  resultado.innerHTML += `<p>${Math.ceil(qtdTotalBebida/2000)} garrafas de 2 litros bebidas</p>`
